...
void ossl_sa_doall_arg(const OPENSSL_SA *sa,
                       void (*leaf)(uintmax_t, void *, void *), void *);
void *ossl_sa_get(const OPENSSL_SA *sa, uintmax_t n);
int ossl_sa_set(OPENSSL_SA *sa, uintmax_t n, void *val);
