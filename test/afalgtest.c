...
static int test_afalg_aes_cbc(int keysize_idx)
{
    ...
    /* Some platforms add a trailing \0 so we don't use string literals here. */
    static const unsigned char in[BUFFER_SIZE] = {
        0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65,
        0x20, 0x62, 0x6c, 0x6f, 0x63, 0x6b,
        0x20, 0x6d, 0x73, 0x67, 0x0a
    };
    static const unsigned char encresult_128[BUFFER_SIZE] = {
        0xe3, 0x53, 0x77, 0x9c, 0x10, 0x79,
        0xae, 0xb8, 0x27, 0x08, 0x94, 0x2d,
        0xbe, 0x77, 0x18, 0x1a, 0x2d
    };
    static const unsigned char encresult_192[BUFFER_SIZE] = {
        0xf7, 0xe4, 0x26, 0xd1, 0xd5, 0x4f,
        0x8f, 0x39, 0xb1, 0x9e, 0xe0, 0xdf,
        0x61, 0xb9, 0xc2, 0x55, 0xeb
    };
    static const unsigned char encresult_256[BUFFER_SIZE] = {
        0xa0, 0x76, 0x85, 0xfd, 0xc1, 0x65,
        0x71, 0x9d, 0xc7, 0xe9, 0x13, 0x6e,
        0xae, 0x55, 0x49, 0xb4, 0x13
    };
