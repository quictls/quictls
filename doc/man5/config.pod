...
containing overrides for the build-in ASN.1 string-table size limits
...
Passed through L<ASN1_str2mask(3)>; defines which ASN.1 string encodings are
permitted (case is not significant).
