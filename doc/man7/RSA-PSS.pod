...
The public key format is documented in RFC 8017, which differs from
RFC 5280, by outputting two extra NULL values (for optional
parameters). OpenSSL release 1.1 and earlier used RFC 5280 style,
while 3.0 and later used RFC 8017.
