...
The public key format is documented in RFC 8017, which differs from RFC 4055
L<section 3.1|https://www.rfc-editor.org/rfc/rfc4055.html#section-3.1>
by outputting two extra NULL values (for optional
parameters). OpenSSL release 1.1 and earlier used RFC 4055 style,
while 3.0 and later use RFC 8017.
