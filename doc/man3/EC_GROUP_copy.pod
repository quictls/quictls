...
EC_GROUP_copy, EC_GROUP_dup, EC_GROUP_set_generator,
...
must be the same type of curve.
...
If a curve does not have a NID associated with it, then EC_GROUP_get_curve_name
