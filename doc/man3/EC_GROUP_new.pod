...
The functions EC_GROUP_new_curve_GFp() sets a default implementation and
then calls the EC_GROUP_set_curve() function.
...
All EC_GROUP "new" functions return a pointer to the newly constructed group, or
NULL on error.
