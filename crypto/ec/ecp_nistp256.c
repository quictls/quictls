...
const EC_METHOD *EC_GFp_nistp256_method(void)
{
    static const EC_METHOD ret = {
        ...
        .group_init = ossl_ec_GFp_nistp256_group_init,
        ...
        .group_set_curve = ossl_ec_GFp_nistp256_group_set_curve,
        ...
        .mul = ossl_ec_GFp_nistp256_points_mul,
        .precompute_mult = ossl_ec_GFp_nistp256_precompute_mult,
