...
{                                                                       \
    static const EC_METHOD EC_GFp_s390x_nistp##bits##_meth = {          \
        ...
        .group_copy = ossl_ec_GFp_simple_group_copy,                    \
        .group_set_curve = ossl_ec_GFp_simple_group_set_curve,          \
        ...
        .mul = ec_GFp_s390x_nistp##bits##_mul,                          \
        .precompute_mult = NULL,                                        \
        .have_precompute_mult = NULL,                                   \
        .field_mul = ossl_ec_GFp_simple_field_mul,                      \
        .field_sqr = ossl_ec_GFp_simple_field_sqr,                      \
        .field_div = NULL,                                              \
        ...
        .ecdsa_verify_sig = ecdsa_s390x_nistp##bits##_verify_sig,       \
