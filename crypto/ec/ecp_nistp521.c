...
const EC_METHOD *EC_GFp_nistp521_method(void)
{
    static const EC_METHOD ret = {
        ...
        .group_init = ossl_ec_GFp_nistp521_group_init,
        ...
        .group_set_curve = ossl_ec_GFp_nistp521_group_set_curve,
        ...
        .mul = ossl_ec_GFp_nistp521_points_mul,
        .precompute_mult = ossl_ec_GFp_nistp521_precompute_mult,
        .have_precompute_mult = ossl_ec_GFp_nistp521_have_precompute_mult,
