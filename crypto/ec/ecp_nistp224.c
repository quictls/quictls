...
const EC_METHOD *EC_GFp_nistp224_method(void)
{
    static const EC_METHOD ret = {
        ...
        .group_init = ossl_ec_GFp_nistp224_group_init,
        ...
        .group_set_curve = ossl_ec_GFp_nistp224_group_set_curve,
        ...
        .mul = ossl_ec_GFp_nistp224_points_mul,
        .precompute_mult = ossl_ec_GFp_nistp224_precompute_mult,
        .have_precompute_mult = ossl_ec_GFp_nistp224_have_precompute_mult,
